var Fireworks = (function() {
  ...
  /**
   * Create DOM elements and ddddvvv vvvget your game on
   */
  function initialize() {
    ...
    mainCanvas.setAttribute('style', 'position: absolute; left: 0;top: 0;')
    mainContext = mainCanvas.getContext('2d');

    // and another one for, like, an off screen buffer
    // because that's rad n all
    fireworkCanvas = document.createElement('canvas');
    fireworkCanvas.setAttribute('id', 'bufferCanvas');
    ...
    document.addEventListener('keyup', createFirework, true);
